...
const getGeoCoords = async function (city) {
  try {
    const result = await fetch(
      `http://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=1&appid=4161baa42cbed26128a94e47e2c270cd`
    );
...
const returnData = async function (lat, lon) {
  const result = await fetch(
    `http://api.openweathermap.org/data/2.5/forecast?&lat=${lat}&lon=${lon}&appid=4161baa42cbed26128a94e47e2c270cd`
  );
